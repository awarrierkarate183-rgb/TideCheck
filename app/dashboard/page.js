...
function WaterGraphic({ risk_label }) {
  ...
  const scenes = {
    LOW: {
      bg: "linear-gradient(180deg, #87CEEB 0%, #1E90FF 40%, #006994 100%)",
      surface: "rgba(135,206,235,0.3)",
      particles: ["🐟", "🐠", "🐬", "🐙", "⭐"],
      text: "✨ Clean & Healthy Waters",
      textColor: "#90EE90",
      description: "Crystal clear and thriving"
    },
    MEDIUM: {
      bg: "linear-gradient(180deg, #8FBC8F 0%, #A3C86D 40%, #6B8E23 100%)",
      surface: "rgba(143,188,143,0.3)",
      particles: ["⚠️", "🌿", "🐟", "💚"],
      text: "⚡ Moderate Concern",
      textColor: "#FFD700",
      description: "Some algae activity detected"
    },
    HIGH: {
      bg: "linear-gradient(180deg, #556B2F 0%, #3B5323 40%, #1A2E0F 100%)",
      surface: "rgba(85,107,47,0.3)",
      particles: ["🦠", "☠️", "🌊", "⚠️"],
      text: "🚨 Algae Bloom Detected",
      textColor: "#FF6B6B",
      description: "Dangerous bloom conditions"
    }
  };

  const scene = scenes[risk_label] || scenes.MEDIUM;
  const particlePositions = [
    {l: 10, t: 40}, {l: 25, t: 60}, {l: 45, t: 35},
    {l: 65, t: 55}, {l: 80, t: 42}, {l: 90, t: 65}
  ];
  ...
  return (
    <div style={{
      ...
      background: scene.bg,
      marginBottom: "28px",
      border: `2px solid ${riskColors[risk_label]}44`,
      boxShadow: `0 0 30px ${riskGlow[risk_label]}, inset 0 0 30px rgba(0,0,0,0.3)`,
      position: "relative",
      overflow: "hidden"
    }}>
      ...
      {particlePositions.map((pos, i) => (
        <div key={i} style={{
          position: "absolute",
          left: `${pos.l}%`,
          top: `${pos.t + Math.sin((frame + i * 20) * 0.1) * 8}%`,
          fontSize: "1.4rem",
...
function DashboardContent() {
  ...
  if (loading || !waterData || !mounted) {
    return (
      <div style={{
        background: "linear-gradient(180deg, #020B18 0%, #0A2342 40%, #0E6B8A 100%)",
        minHeight: "100vh",
        display: "flex",
        alignItems: "center",
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "28px" }}>
          <h1 style={{
            ...
            fontWeight: "900",
            marginBottom: "8px",
            textShadow: "0 0 30px rgba(14,107,138,0.8)"
          }}>🌊 TideCheck</h1>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: "28px" }}>
          <div style={{
            ...
            padding: "14px 40px",
            borderRadius: "50px",
            animation: waterData.risk_label === "HIGH" ? "pulse 1.5s infinite" : "none",
            boxShadow: `0 0 40px ${riskGlow[waterData.risk_label]}, 0 4px 20px rgba(0,0,0,0.4)`,
            letterSpacing: "2px",
        ...
        <div style={{
          ...
          overflow: "hidden",
          marginBottom: "28px",
          boxShadow: `0 0 30px ${riskGlow[waterData.risk_label]}, 0 8px 30px rgba(0,0,0,0.4)`,
          border: `2px solid ${riskColors[waterData.risk_label]}44`
        }}>
          <MapContainer
          ...
          >
            ...
            <Circle center={[waterData.lat, waterData.lng]} radius={800} color={riskColors[waterData.risk_label]} fillOpacity={0.25} weight={3}>
              <Popup>
                <strong>{waterData.water_name}</strong><br />
                Risk: {waterData.risk_label}<br />
                ZIP: {zip}
              </Popup>
            </Circle>
          </MapContainer>
        ...
        <div style={{
          ...
          <p style={{
            ...
            fontSize: "1rem",
            fontStyle: "italic",
            borderLeft: `4px solid ${riskColors[waterData.risk_label]}`,
            paddingLeft: "16px"
          }}>{aiSummary?.summary}</p>
            ...
            {aiSummary?.actions?.map((action, idx) => (
              <div
                ...
                style={{
                  ...
                  padding: "12px 16px",
                  borderRadius: "12px",
                  background: checked[idx] ? "rgba(46,204,113,0.15)" : "rgba(255,255,255,0.05)",
                  border: `1px solid ${checked[idx] ? "rgba(46,204,113,0.4)" : "rgba(255,255,255,0.1)"}`,
                  transition: "all 0.2s"
                }}
              >
                <div style={{
                  ...
                  height: "24px",
                  borderRadius: "8px",
                  border: `2px solid ${checked[idx] ? "#2ECC71" : "rgba(255,255,255,0.3)"}`,
          ...
          {allChecked && (
            <div style={{
              ...
              <p style={{ color: "#2ECC71", fontWeight: "bold", fontSize: "1.1rem" }}>
                🎉 Amazing! You are making a real difference! 🌊
              </p>
            </div>
          )}
          ...
          {aiSummary?.safety_note && (
            <div style={{
              ...
              <p style={{ color: "#FF6B6B", fontWeight: "bold", fontSize: "0.95rem" }}>
                🚨 {aiSummary.safety_note}
              </p>
            </div>
          )}
